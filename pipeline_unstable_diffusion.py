...
class Img2Img:
    def __init__(self, init_image: PIL.Image.Image, strength: float = 0.8):
        """
        Args:
...
class Inpaint:
    def __init__(self, init_image, mask_image: PIL.Image.Image, strength: float = 0.8):
        """
        Args:
            init_image `PIL.Image.Image`:
                `Image`, or tensor representing an image batch, that will be used as the starting point for the
        ...
        **kwargs,
        ...
        with autocast("cuda"):
            ...
            (
                ...
                self, text_embeddings.dtype, num_inference_steps, generator
            )
